...
- [ ] **Phase 1: Storage & GPS Foundation** - IndexedDB storage layer and GPS filtering pipeline replace unreliable localStorage and raw GPS
...
|-------|----------------|--------|-----------|
| 1. Storage & GPS Foundation | 4/5 | Gap closure planned | - |
