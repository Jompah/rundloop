const en = {
  ...
  'auth.codeSentDesc': "We sent a code to {email}. Enter it below, or click the link in the email if you're on the same device.",
  'auth.codePlaceholder': 'Code from email',
