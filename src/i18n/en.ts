const en = {
  ...
  'gps.permissionDeniedDetail': 'Location access has been denied. Open your browser settings and allow location access for this site, or use a simulated position.',
  'gps.retry': 'Try again',
