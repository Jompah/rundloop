...
const sv: Record<TranslationKey, string> = {
  ...
  'auth.codeSentDesc': 'Vi skickade en kod till {email}. Skriv in den nedan, eller klicka på länken i mailet om du är på samma enhet.',
  'auth.codePlaceholder': 'Kod från mailet',
